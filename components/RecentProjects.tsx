    ...
    <section id="projects" className="py-20">
      ...
      <div className="flex justify-end lg:mr-24 mr-32 p-4 gap-8">
        <div className="border-2 border-Brown/40 h-full lg:w-[40rem] lg:mt-[16rem] md:mt-[16rem] mt-[20rem] p-4 rounded-lg shadow-xl shadow-Brown/10">
          ...
          <div className="flex flex-wrap items-center justify-between mb-1">
            ...
            <a href="https://dwello-estates.netlify.app/"  className="z-10">
            <Button
        ...
        <div className="lg:min-h-[32.5rem] h-[25rem] flex items-center justify-center sm:w-96 w-[80vw]">
          <PinContainer title="DwelloEstates" href="https://twitter.com/mannupaaji">
            <div className="relative flex items-center justify-center sm:w-96 w-[80vw] overflow-hidden h-[20vh] lg:h-[30vh] mb-10">
              <div className="relative w-full h-full overflow-hidden lg:rounded-3xl opacity-15" style={{ backgroundColor: "#DAC5A7" }}></div>
              <Image
      ...
      <div className="flex justify-end lg:mr-24 gap-8 p-4 mt-[-4rem]">
        <div className="lg:min-h-[32.5rem] h-[25rem] flex items-center justify-center sm:w-96 w-[80vw] lg:ml-0 ml-[10rem]">
          <PinContainer title="Infinity" href="https://twitter.com/mannupaaji">
            <div className="relative flex items-center justify-center sm:w-96 w-[80vw] overflow-hidden h-[20vh] lg:h-[30vh] mb-10">
              <div className="relative w-full h-full overflow-hidden lg:rounded-3xl opacity-15" style={{ backgroundColor: "#DAC5A7" }}>
        ...
        <div className="border-2 border-Brown/40 h-full w-[40rem] lg:mt-[16rem] md:mt-[16rem] mt-[20rem] p-4 rounded-lg shadow-xl shadow-Brown/10">
          <p className="lg:text-xl lg:font-normal font-light text-sm line-clamp-3 text-Brown/80">
            {"Sleek Design with Parallax Effects, employing React.js+vite.js and Tailwind CSS to design a visually stunning and immersive user experience with modern parallax effects and bento box layouts. It increases 40% of user interaction."}
          </p>
          ...
          <div className="flex flex-wrap items-center justify-between mb-1">
            ...
            <div className="flex justify-center items-center pt-4">
            <a href="https://infinity-ai.netlify.app/"  className="z-10">
            <Button
              title="Check Live Site"
              icon={<GoArrowUpRight/>}
              position="right"
